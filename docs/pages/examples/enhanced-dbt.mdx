...
<Image
  ...
  height={200}
  width={200}
  alt="Snowflake Connection button"
/>
...
<Callout type="info" emoji="ℹ️">
  Using the same `Namespace` value for both Snowflake and dbt insures the tables
...
<Callout type="info" emoji="ℹ️">
  ...
  [jaffle_shop_snowflake_demo](https://github.com/grai-io/jaffle_shop_snowflake_demo).
</Callout>
