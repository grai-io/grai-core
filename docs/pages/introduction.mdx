...
Most out of the box integrations concentrate on representing tables, views and columns, however, they can represent whatever you need simply by using the [client](/core/tooling/client) to communicate with the server.
...
Much like a node, an edge reprsent anything that connects two nodes, and can store any arbitrary data like a SQL script describing the conversion between two nodes.
...
Grai operates a **completely flexible strucutre** which means you can add and manage any fields you like, or update them however and whenever you need.

## Automatic Integrations

We provide autommatic integrations to access metadata from common sources.
