...
Start managing your metadata and testing your pipelines in three easy steps [here](/core/quick-start). We walk through how to:
...
- [Client Library](/core/tooling/client)
- [CLI Library](/core/tooling/cli)
- [Graph Library](/core/tooling/graph-library)
- [GitHub Action](/core/tooling/github-actions)
- [GitHub Action Server](/core/tooling/github-actions-server)

## Web App

Grai's Web App offers an easy to use web interface and is available open-source or as part of the cloud-hosted platform.

- [Getting Started](/core/web-app/getting-started)
- [Users](/core/web-app/users)
- [Workspaces](/core/web-app/workspaces)
- [Setup Emails](/core/web-app/setup-emails)
