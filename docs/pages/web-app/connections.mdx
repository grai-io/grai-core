...
<Image
  src="/images/docs/core/webapp/postgres.png"
  height={600}
  width={1200}
  alt="Grai web app postgres connection example."
/>
...
<Image
  ...
  height={600}
  width={1200}
  alt="Grai web app connections example."
/>
...
<Image
  ...
  height={200}
  width={200}
  alt="Grai web app add connection button example."
/>
...
<br />
<Image
  src="/images/docs/core/webapp/runs.png"
  height={600}
  width={1200}
  alt="Grai web app runs example."
/>
...
<br />
<Image
  src="/images/docs/core/webapp/refresh.png"
  height={100}
  width={100}
  alt="Grai web app refresh button example."
/>
...
<Image src="/images/docs/core/webapp/run.png" height={600} width={1200} alt="Grai web app run example."/>
...
<Image
  ...
  height={600}
  width={1200}
  alt="Grai web app configuration example"
/>
...
<br />
<Image src="/images/docs/core/webapp/schedule.png" height={600} width={1200} alt="Grai web app schedule example"/>
