...
export interface GetCommit_workspace_graph_columns_destinations {
...
export interface GetCommit_workspace_graph_columns {
  ...
  name: string;
  display_name: string;
  destinations: GetCommit_workspace_graph_columns_destinations[];
}

export interface GetCommit_workspace_graph_destinations {
...
export interface GetCommit_workspace_graph {
  ...
  destinations: GetCommit_workspace_graph_destinations[];
}
