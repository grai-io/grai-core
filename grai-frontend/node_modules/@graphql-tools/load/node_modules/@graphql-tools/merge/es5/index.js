...
function addDescription(cb) {
    return function (node, _key, _parent, path, ancestors) {
        ...
        var key = tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(keys)), [(_a = parent === null || parent === void 0 ? void 0 : parent.name) === null || _a === void 0 ? void 0 : _a.value]).filter(Boolean).join('.');
        var items = [];
