...
exports.getDominantColor = exports.getSrcSet = exports.getSizes = void 0;
...
function responsiveImageSizes({
  ...
  height = height && Math.min(height, imgDimensions.height); // Case 2: neither width or height were passed in, use default size
  ...
  if ((breakpoints === null || breakpoints === void 0 ? void 0 : breakpoints.length) > 0) {
    sizes = breakpoints.filter(size => size <= imgDimensions.width); // If a larger breakpoint has been filtered-out, add the actual image width instead
