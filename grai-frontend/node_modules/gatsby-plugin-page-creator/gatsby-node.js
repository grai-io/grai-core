...
try {
  var _require = require("gatsby-plugin-utils"),
      isGatsbyNodeLifecycleSupported = _require.isGatsbyNodeLifecycleSupported;
...
function initializePlugin(_x4, _x5) {
  return _initializePlugin.apply(this, arguments);
}

function _initializePlugin() {
  _initializePlugin = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3(_ref6, _ref7) {
