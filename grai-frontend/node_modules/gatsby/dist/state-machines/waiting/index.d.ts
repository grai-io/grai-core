...
export declare const waitingMachine: import("xstate").StateMachine<IWaitingContext, any, import("redux").AnyAction, {
    value: any;
    context: IWaitingContext;
}, import("xstate").ActionObject<IWaitingContext, import("redux").AnyAction>>;
