...
const seedConstant = `638f7a53-c567-4eca-8fc1-b23efb1cfb2b`; // This cache prevents duplicate calls to uuid which is relevant for certain cases

const unprefixedCache = new Map(); // ns -> name -> uuid
