...
function isTemplateQuery(node, graphqlTagName, namespaceSpecifierName) {
  ...
  return node.type === `ExportNamedDeclaration` && ((_node$declaration3 = node.declaration) === null || _node$declaration3 === void 0 ? void 0 : _node$declaration3.type) === `VariableDeclaration` && ((_node$declaration4 = node.declaration) === null || _node$declaration4 === void 0 ? void 0 : _node$declaration4.declarations.every(el => {
