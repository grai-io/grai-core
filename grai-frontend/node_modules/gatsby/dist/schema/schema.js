...
const buildSchema = async ({
  ...
  freezeTypeComposers(schemaComposer); // console.log(printSchema(schema))
...
const parseTypes = ({
  ...
  doc.definitions.forEach(def => {
    ...
    if (schemaComposer.has(name)) {
      ...
      const parsedType = schemaComposer.typeMapper.makeSchemaDef(def); // Merging types require implemented interfaces to already exist.
