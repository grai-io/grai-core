...
var foundations_typography_dist_chakraUiThemeFoundationsTypography = require('../foundations/typography/dist/chakra-ui-theme-foundations-typography.cjs.prod.js');
...
function getSize$3(size) {
  var themeSize = foundations_sizes_dist_chakraUiThemeFoundationsSizes.sizes[size];
  return {
    container: {
      width: size,
      height: size,
...
var variantOutline$1 = function variantOutline(props) {
  ...
  return foundations_sizes_dist_chakraUiThemeFoundationsSizes._extends({
    border: "1px solid",
...
var baseStyleDialog$1 = function baseStyleDialog(props) {
  ...
  return foundations_sizes_dist_chakraUiThemeFoundationsSizes._extends({}, isFullHeight && {
    height: "100vh"
  }, {
    zIndex: "modal",
    maxH: "100vh",
...
function getSize(size) {
  ...
  var fontSize = foundations_typography_dist_chakraUiThemeFoundationsTypography["default"].fontSizes[_fontSize.toString()];

  return {
    field: foundations_sizes_dist_chakraUiThemeFoundationsSizes._extends({}, sizeStyle.field, {
...
var baseStyle$f = foundations_sizes_dist_chakraUiThemeFoundationsSizes._extends({}, Input.baseStyle.field, {
  textAlign: "center"
});
...
function filledStyle(props) {
  ...
  return foundations_sizes_dist_chakraUiThemeFoundationsSizes._extends({}, addStripe && stripeStyle, isIndeterminate ? {
    bgImage: gradient
  } : {
    bgColor: bgColor
  });
...
var baseStyleControl = function baseStyleControl(props) {
  ...
  return foundations_sizes_dist_chakraUiThemeFoundationsSizes._extends({}, control, {
    borderRadius: "full",
    _checked: foundations_sizes_dist_chakraUiThemeFoundationsSizes._extends({}, control["_checked"], {
      _before: {
        content: "\"\"",
...
var baseStyleField = function baseStyleField(props) {
  return foundations_sizes_dist_chakraUiThemeFoundationsSizes._extends({}, Input.baseStyle.field, {
    bg: themeTools.mode("white", "gray.700")(props),
    appearance: "none",
    paddingBottom: "1px",
    lineHeight: "normal",
...
var variantSimple = function variantSimple(props) {
  var c = props.colorScheme;
  return {
    th: foundations_sizes_dist_chakraUiThemeFoundationsSizes._extends({
      color: themeTools.mode("gray.600", "gray.400")(props),
      borderBottom: "1px",
      borderColor: themeTools.mode(c + ".100", c + ".700")(props)
    }, numericStyles),
    td: foundations_sizes_dist_chakraUiThemeFoundationsSizes._extends({
      borderBottom: "1px",
      borderColor: themeTools.mode(c + ".100", c + ".700")(props)
    }, numericStyles),
    caption: {
...
var baseStyle$1 = foundations_sizes_dist_chakraUiThemeFoundationsSizes._extends({}, Input.baseStyle.field, {
  paddingY: "8px",
  minHeight: "80px",
  lineHeight: "short",
  verticalAlign: "top"
