import type { StyleObjectOrFn, SemanticValue, Pseudos } from "@chakra-ui/styled-system";
import type { ColorMode, ColorModeOptions, ThemingProps } from "@chakra-ui/system";
import type { Breakpoints, PartsStyleInterpolation, Styles, SystemStyleInterpolation } from "@chakra-ui/theme-tools";
...
export declare type ThemeComponentFunction<S, T extends ChakraTheme = ChakraTheme> = (props: ThemeComponentProps<T>) => S;
export declare type ThemingPropsThunk<S, T extends ChakraTheme = ChakraTheme> = S | ThemeComponentFunction<S, T>;
...
export declare type ComponentStyleConfig = ComponentSingleStyleConfig | ComponentMultiStyleConfig;
