...
function useRangeSlider(props) {
  ...
  var onChangeStart = hooks.useCallbackRef(onChangeStartProp);
  var onChangeEnd = hooks.useCallbackRef(onChangeEndProp);
  ...
  var value = valueState.map(function (val) {
    return utils.clampValue(val, min, max);
  });
  var valueRef = hooks.useLatestRef(value);
  ...
  var thumbPercents = thumbValues.map(function (val) {
    return utils.valueToPercent(val, min, max);
  });
  ...
  var getThumbProps = React.useCallback(function (props, ref) {
    ...
    return _extends({}, rest, {
      ...
      onFocus: utils.callAllHandlers(props.onFocus, function () {
        setFocused.on();
        setActiveIndex(index);
      }),
      onBlur: utils.callAllHandlers(props.onBlur, function () {
        setFocused.off();
        setActiveIndex(-1);
      })
    });
  ...
  var getMarkerProps = React.useCallback(function (props, ref) {
    ...
    var percent = utils.valueToPercent(v, min, max);
 ...
 */
var RangeSlider = /*#__PURE__*/system.forwardRef(function (props, ref) {
  var styles = system.useMultiStyleConfig("Slider", props);
 ...
 */
var RangeSliderThumb = /*#__PURE__*/system.forwardRef(function (props, ref) {
...
var RangeSliderTrack = /*#__PURE__*/system.forwardRef(function (props, ref) {
...
var RangeSliderFilledTrack = /*#__PURE__*/system.forwardRef(function (props, ref) {
 ...
 */
var RangeSliderMark = /*#__PURE__*/system.forwardRef(function (props, ref) {
...
function useSlider(props) {
  ...
  var _useIds = hooks.useIds(idProp, "slider-thumb", "slider-track"),
      thumbId = _useIds[0],
      trackId = _useIds[1];
  /**
  ...
  var getValueFromPointer = React.useCallback(function (event) {
    ...
    if (!trackRef.current) return;
    eventSourceRef.current = "pointer";
    var trackRect = utils.getBox(trackRef.current).borderBox;
    ...
    var nextValue = utils.percentToValue(percent, min, max);
  ...
  var thumbBoxModel = hooks.useDimensions(thumbRef);
  /**
   * Compute styles for all component parts.
   */
  ...
  var focusThumb = React.useCallback(function () {
    if (thumbRef.current && focusThumbOnChange) {
      setTimeout(function () {
        return utils.focus(thumbRef.current);
      });
    }
  }, [focusThumbOnChange]);
  hooks.useUpdateEffect(function () {
  ...
  var getMarkerProps = React.useCallback(function (props, ref) {
    ...
    var markerPercent = utils.valueToPercent(props.value, min, max);
 ...
 * @see WAI-ARIA https://www.w3.org/TR/wai-aria-practices/#slider
 */
var Slider = /*#__PURE__*/system.forwardRef(function (props, ref) {
  var styles = system.useMultiStyleConfig("Slider", props);
  var ownProps = system.omitThemingProps(props);
  ...
  return /*#__PURE__*/React__namespace.createElement(SliderProvider, {
    ...
    className: utils.cx("chakra-slider", props.className),
    __css: styles.container
 ...
 * values by dragging its handle along the track
 */
var SliderThumb = /*#__PURE__*/system.forwardRef(function (props, ref) {
...
var SliderTrack = /*#__PURE__*/system.forwardRef(function (props, ref) {
...
var SliderFilledTrack = /*#__PURE__*/system.forwardRef(function (props, ref) {
 ...
 * @see Docs https://chakra-ui.com/slider
 */
var SliderMark = /*#__PURE__*/system.forwardRef(function (props, ref) {
