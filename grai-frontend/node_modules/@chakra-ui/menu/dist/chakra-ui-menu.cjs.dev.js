...
var MenuTransition = "custom" in framerMotion.motion ? framerMotion.motion.custom(system.chakra.div) : framerMotion.motion(system.chakra.div);
var MenuList = /*#__PURE__*/system.forwardRef(function (props, ref) {
  ...
  }), /*#__PURE__*/React__namespace.createElement(MenuTransition, _extends({}, ownProps, {
    /**
     * We could call this on either `onAnimationComplete` or `onUpdate`.
     * It seems the re-focusing works better with the `onUpdate`
     */
    onUpdate: onTransitionEnd,
    onAnimationComplete: utils.callAll(animated.onComplete, ownProps.onAnimationComplete),
    className: utils.cx("chakra-menu__menu-list", ownProps.className),
